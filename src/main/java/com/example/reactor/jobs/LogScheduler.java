...
public class LogScheduler {
    ...
    @Scheduled(
        fixedDelay = 20000, // will run after delay of 5 seconds, from the last run completion means no overlapping
        initialDelay = 10000 // its optional arg which will wait initially after running the application then will run normally
    )
